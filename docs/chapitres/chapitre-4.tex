...
\subsubsection{Diagramme de classes de conception}
...
\begin{itemize}[itemsep=1pt, parsep=1pt]
    ...
    La Figure 4.10 illustre le diagramme de séquence de conception \textbf{« Démarrer chat »} 
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.32\textwidth,height=1\textwidth,angle=90]{images/chp4/fig10.png}
